...
RSpec.describe RostersController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new roster" do

        post :create, params: {roster: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(roster_url(Roster.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new roster" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the roster" do
        roster = Roster.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the roster" do
        roster = Roster.create! valid_attributes
